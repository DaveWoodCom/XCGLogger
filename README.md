...
```github "DaveWoodCom/XCGLogger" ~> 5.0.2```
...
`pod 'XCGLogger/UserInfoHelpers', '~> 5.0.2'`: Include some experimental code to help deal with using UserInfo dictionaries to tag log messages.
...
Use:
* XCGLogger version [5.0.2][xcglogger-5.0.2] for Swift 3.0-3.1
...
[badge-swiftpm]: https://img.shields.io/badge/Swift_Package_Manager-v5.0.2-64a6dd.svg?style=flat
[badge-cocoapods]: https://img.shields.io/cocoapods/v/XCGLogger.svg?style=flat
[badge-carthage]: https://img.shields.io/badge/Carthage-v5.0.2-64a6dd.svg?style=flat
...
[xcglogger-5.0.2]: https://github.com/DaveWoodCom/XCGLogger/releases/tag/5.0.2
