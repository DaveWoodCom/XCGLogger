...
```github "DaveWoodCom/XCGLogger" ~> 7.1.0```
...
`pod 'XCGLogger/UserInfoHelpers', '~> 7.1.0'`: Include some experimental code to help deal with using UserInfo dictionaries to tag log messages.
...
Use:
* XCGLogger version [7.1.0][xcglogger-7.1.0] for Swift 5.0
...
[xcglogger-7.1.0]: https://github.com/DaveWoodCom/XCGLogger/releases/tag/7.1.0
